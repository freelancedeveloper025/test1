GleecBTC Core version 0.16.3 is now available from:

  <https://gleecbtccore.org/bin/gleecbtc-core-0.16.3/>
...
been discovered in GleecBTC Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` gleecbtcconsensus: invalid flags error should be set to `gleecbtcconsensus_err` (afk11)

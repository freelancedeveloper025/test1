GleecBTC Core version *0.15.2* is now available from:

  <https://gleecbtccore.org/bin/gleecbtc-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in gleecbtc-tx (TheBlueMatt)

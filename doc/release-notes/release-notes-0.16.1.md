GleecBTC Core version 0.16.1 is now available from:

  <https://gleecbtccore.org/bin/gleecbtc-core-0.16.1/>
...
- #12843 `df38b13` Test starting gleecbtcd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure gleecbtcd processes are cleaned up when tests end (sdaftuar)

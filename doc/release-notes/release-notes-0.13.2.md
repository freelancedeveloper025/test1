GleecBTC Core version 0.13.2 is now available from:

  <https://gleecbtc.org/bin/gleecbtc-core-0.13.2/>
...
- #8908 `4a974b2` Update gleecbtc-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gleecbtc-tx to create v2 transactions (gleecdrak)

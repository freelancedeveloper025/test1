...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the gleecbtc.org server
...
- Update other repositories and websites for new version
  ...
  - gleecbtccore.org maintained versions update:
    [table](https://github.com/gleecbtc-core/gleecbtccore.org/commits/master/_includes/posts/maintenance-table.md)

  - gleecbtccore.org RPC documentation update
